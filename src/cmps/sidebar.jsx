    ...
    <Fragment>
     <CreatePostModal />
      <section className="side-bar" >
          <a className='ig-title' href='/'><img src='https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Instagram_logo.svg/2560px-Instagram_logo.svg.png' 
          style={{ width: "100px", marginLeft: "12px" }} /></a>
